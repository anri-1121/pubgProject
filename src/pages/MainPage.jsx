    ...
    <>
      ...
      <section className="tournamentList">
        ...
        <div
          ...
          onMouseOut={() => setEuDesc(false)}
        >
          <h1><span>Europian</span> tournament schedule</h1>
          <ul>
            {EuSchedule.map((i) => (
              <li key={i.id}>{i.title} <span>{i.date}</span></li>
            ))}
          </ul>
        </div>
        <div className="card">
        ...
        <div
          ...
          onMouseOut={() => setRusDesc(false)}
        >
          <h1><span>Russian</span> tournament schedule</h1>
          <ul>
            {RusSchedule.map((i) => (
        ...
        <div
          ...
          onMouseOut={() => setArabDesc(false)}
        >
          <h1><span>Arabian</span> tournament schedule</h1>
          <ul>
            {ArabSchedule.map((i) => (
              <li key={i.id}>{i.title}</li>
            ))}
        ...
        <div
          ...
          onMouseOut={() => setArabDesc(false)}
        >
          <h1><span>Georgian</span> tournament schedule</h1>
          <ul>
            {GeoSchedule.map((i) => (
              <li key={i.id}>{i.title}</li>
            ))}
